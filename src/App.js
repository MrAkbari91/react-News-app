...
export default class App extends Component {
  ...
  render() {
    ...
    let navitem = ['business', 'entertainment', 'environment', 'food', 'health', 'politics', 'science', 'sports', 'technology', 'world']

    const { darkMode } = this.state;
    // const apiKey = "ad43284cea444327832f0de1a4292f24"    //     api = 100
    ...
    return (
      <Router>
        <div className='dark:bg-gray-700 dark:text-gray-100'>
          ...
          <Routes>
          <Route exact path='/' element={<News key='top'apiKey={apiKey} country='in' category='top' />}></Route>
